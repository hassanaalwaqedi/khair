      ...
      children: [
        Padding(
          ...
          child: Row(children: [
            ...
            Text(context.l10n.sheikhLearnFromScholars,
                style: TextStyle(
                    fontSize: 20,
        ...
        child: Column(
          children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: KhairColors.primary.withValues(alpha: 0.2),
                        width: 2),
                  ...
                  child: imgUrl.isEmpty
                      ? Center(
                          child: Text(
                          sheikh.name.isNotEmpty
                              ? sheikh.name[0].toUpperCase()
                              : context.l10n.sheikhDefaultName[0],
                          style: TextStyle(
            ...
            Text(sheikh.name,
                ...
                style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.w700, color: tp)),
            const SizedBox(height: 3),
            // Specialty
            Text(
              sheikh.specialization ?? context.l10n.sheikhDefaultSpecialization,
              textAlign: TextAlign.center,
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700, color: tp),
                  ),
                  const SizedBox(width: 2),
